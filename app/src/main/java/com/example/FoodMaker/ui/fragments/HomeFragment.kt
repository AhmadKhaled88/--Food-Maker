...
import com.example.FoodMaker.adapters.CategoriesRecyclerAdapter
import com.example.FoodMaker.adapters.MostPopularRecyclerAdapter
import com.example.FoodMaker.adapters.OnItemClick
import com.example.FoodMaker.adapters.OnLongItemClick
import com.example.FoodMaker.data.pojo.*
import com.example.FoodMaker.databinding.FragmentHomeBinding
import com.example.FoodMaker.mvvm.DetailsMVVM
import com.example.FoodMaker.mvvm.MainFragMVVM
import com.example.FoodMaker.ui.activites.MealActivity
import com.example.FoodMaker.ui.MealBottomDialog
...
//                setCategoryAdapter(categories)
        ...
        detailMvvm.observeMealBottomSheet()
            .observe(viewLifecycleOwner, object : Observer<List<MealDetail>> {
                override fun onChanged(t: List<MealDetail>?) {
                    ...
                    b.putString(MEAL_NAME, t[0].strArea)
    ...
    private fun showLoadingCase() {
        binding.apply {
          ...
          //  rootHome.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.black))
